...
void PlaybackController::init()
{
    ...
    d->onRequest(this, PLAY_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return togglePlay(request); });
    d->onRequest(this, PLAY_COMMAND, [this](const rcommand::Request& request) { return play(request); });
    d->onRequest(this, PLAY_SELECTION_COMMAND, [this](const rcommand::Request& request) { return playFromSelection(request); });
    d->onRequest(this, PAUSE_COMMAND, [this](const rcommand::Request& request) { return pause(request); });
    d->onRequest(this, PAUSE_AND_SELECT_COMMAND, [this](const rcommand::Request& request) { return pause(request, true); });
    d->onRequest(this, STOP_COMMAND, [this](const rcommand::Request& request) { return stop(request); });
    d->onRequest(this, REWIND_COMMAND, [this](const rcommand::Request& request) { return rewind(request); });
    d->onRequest(this, LOOP_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleLoopPlayback(request); });
    d->onRequest(this, LOOP_IN_COMMAND, [this](const rcommand::Request& request) { return addLoopBoundary(request, LoopBoundaryType::LoopIn); });
    d->onRequest(this, LOOP_OUT_COMMAND, [this](const rcommand::Request& request) { return addLoopBoundary(request, LoopBoundaryType::LoopOut); });
    d->onRequest(this, METRONOME_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleMetronome(request); });
    d->onRequest(this, SHOW_PLAYBACK_SETUP_COMMAND, [this](const rcommand::Request& request) { return showPlaybackSetup(request); });
    d->onRequest(this, MIDI_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleMidiInput(request); });
    d->onRequest(this, MIDI_INPUT_WRITTEN_PITCH_COMMAND, [this](const rcommand::Request& request) { return setMidiUseWrittenPitch(request, true); });
    d->onRequest(this, MIDI_INPUT_SOUNDING_PITCH_COMMAND, [this](const rcommand::Request& request) { return setMidiUseWrittenPitch(request, false); });
    d->onRequest(this, REPEATS_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return togglePlayRepeats(request); });
    d->onRequest(this, CHORDSYMBOLS_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return togglePlayChordSymbols(request); });
    d->onRequest(this, HEAR_PLAYBACK_WHEN_EDITING_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleHearPlaybackWhenEditing(request); });
    d->onRequest(this, PAN_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleAutomaticallyPan(request); });
    d->onRequest(this, COUNTIN_TOGGLE_COMMAND, [this](const rcommand::Request& request) { return toggleCountIn(request); });
    d->onRequest(this, RELOAD_PLAYBACK_CACHE_COMMAND, [this](const rcommand::Request& request) { return reloadPlaybackCache(request); });
...
// Trampolines:
muse::rcommand::Response PlaybackController::togglePlay(const muse::rcommand::Request& request)
{
    togglePlay();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::play(const muse::rcommand::Request& request, bool showErrors)
{
    play();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::playFromSelection(const muse::rcommand::Request& request, bool showErrors)
{
    playFromSelection(showErrors);
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::pause(const muse::rcommand::Request& request, bool select)
{
    pause(select);
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::stop(const muse::rcommand::Request& request)
{
    stop();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleLoopPlayback(const muse::rcommand::Request& request)
{
    toggleLoopPlayback();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::addLoopBoundary(const muse::rcommand::Request& request, engraving::LoopBoundaryType type)
{
    addLoopBoundary(type);
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleMetronome(const muse::rcommand::Request& request)
{
    toggleMetronome();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::showPlaybackSetup(const muse::rcommand::Request& request)
{
    showPlaybackSetup();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleMidiInput(const muse::rcommand::Request& request)
{
    toggleMidiInput();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::setMidiUseWrittenPitch(const muse::rcommand::Request& request, bool useWrittenPitch)
{
    setMidiUseWrittenPitch(useWrittenPitch);
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::togglePlayRepeats(const muse::rcommand::Request& request)
{
    togglePlayRepeats();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::togglePlayChordSymbols(const muse::rcommand::Request& request)
{
    togglePlayChordSymbols();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleHearPlaybackWhenEditing(const muse::rcommand::Request& request)
{
    toggleHearPlaybackWhenEditing();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleAutomaticallyPan(const muse::rcommand::Request& request)
{
    toggleAutomaticallyPan();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::toggleCountIn(const rcommand::Request& request)
{
    toggleCountIn();
    return muse::rcommand::make_response(request, make_ok());
}

muse::rcommand::Response PlaybackController::reloadPlaybackCache(const muse::rcommand::Request& request)
{
    reloadPlaybackCache();
    return muse::rcommand::make_response(request, make_ok());
}
