...
private:
    ...
    // Trampolines:
    muse::rcommand::Response togglePlay(const muse::rcommand::Request& request);
    muse::rcommand::Response play(const muse::rcommand::Request& request, bool showErrors = true);
    muse::rcommand::Response playFromSelection(const muse::rcommand::Request& request, bool showErrors = true);
    muse::rcommand::Response pause(const muse::rcommand::Request& request, bool select = false);
    muse::rcommand::Response stop(const muse::rcommand::Request& request);
    muse::rcommand::Response toggleLoopPlayback(const muse::rcommand::Request& request);
    muse::rcommand::Response addLoopBoundary(const muse::rcommand::Request& request, engraving::LoopBoundaryType type);
    muse::rcommand::Response toggleMetronome(const muse::rcommand::Request& request);
    muse::rcommand::Response showPlaybackSetup(const muse::rcommand::Request& request);
    muse::rcommand::Response toggleMidiInput(const muse::rcommand::Request& request);
    muse::rcommand::Response setMidiUseWrittenPitch(const muse::rcommand::Request& request, bool useWrittenPitch);
    muse::rcommand::Response togglePlayRepeats(const muse::rcommand::Request& request);
    muse::rcommand::Response togglePlayChordSymbols(const muse::rcommand::Request& request);
    muse::rcommand::Response toggleHearPlaybackWhenEditing(const muse::rcommand::Request& request);
    muse::rcommand::Response toggleAutomaticallyPan(const muse::rcommand::Request& request);
    muse::rcommand::Response toggleCountIn(const muse::rcommand::Request& request);
    muse::rcommand::Response reloadPlaybackCache(const muse::rcommand::Request& request);
